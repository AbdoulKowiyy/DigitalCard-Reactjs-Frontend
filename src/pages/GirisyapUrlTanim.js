...
import { loginUserUrlTanimla } from "../redux/actions/userActions";
...
export class GiriyapUrlTanim extends Component {
  constructor() {
    super();
    this.state = {
      email: "",
  ...
  handleSubmit = (event) => {
    ...
    var veriData = {
      ...
      onurlLinkiId: this.props.match.params.screamid,
      userHandle:this.state.userHandle
    };
    
    this.props.loginUserUrlTanimla(veriData, this.props.history);
  };
        ...
        <Grid item xs={12} sm={4} md={5} className={classes.middleStuf}>
          <Grid container  paddingLeft={{xs:"20px" , md:"0" , sm:"0" , lg:"0"}} paddingRight={{xs:"20px" , md:"0" , sm:"0" , lg:"0"}}>
            <Grid
              ...
              sm={12}
              md={12}
              margin={{ xs: "0", md: "100px", sm: "0", lg: "100px" }}
...
<TextField id="password" name="password" type={passwordIsMasked ? 'password' : 'text'} label="Parola" 
          ...
          />
                ...
                <small className={classes.botomTitle}>
                  {" "}
                  Üye değilseniz,{" "}
                  <Link to={base1} style={{ color: "#2181ff" }}>
                    {" "}
                    Üye Olun.{" "}
                  </Link>{" "}
                </small>{" "}
   ...
   <DialogActions>
       ...
       <Button onClick={this.parolaChangeArayuz} color="primary">
        ...
        <Grid
          ...
          sm={8}
          md={7}
          className={classes.seconPartAll}
          display={{ xs: "none", sm: "block", md: "block" }}
        >
          <Grid container>
            <Grid item xs={12} className={classes.secondPartBack}></Grid>
          </Grid>
        </Grid>
      </Grid>
    );
...
GiriyapUrlTanim.protoTypes = {
  classes: PropTypes.object.isRequired,
  loginUserUrlTanimla: PropTypes.func.isRequired,
...
export default connect(
  mapStateToProps,
  mapActionsToProps
)(withStyles(styles)(GiriyapUrlTanim));
