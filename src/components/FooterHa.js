...
<Grid container xs={12} >
    <Grid xs={12} md={6} sm={6} style={{float:"left", padding:"5px"}} textAlign={{xs:"center", md:"left", sm:"left" }}>
        <Typography variant="h6" style={{color:"lightgray", fontSize:"16px"}}>
            © 2022 | Design and Development by <a href="https://hibritmedya.com.tr" target="_blank" style={{color:"#fdd140"}}>Hibrit Medya</a>
        </Typography>
    </Grid>
    <Grid xs={12} md={6} sm={6} style={{float:"right", padding:"5px" }} textAlign={{xs:"center", md:"right", sm:"right" }}>
        <Typography variant="h6" style={{color:"lightgray", fontSize:"16px"}}>
